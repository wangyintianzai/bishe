...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑安排咨询:</div>
            <div class="panel-body">
                <form action="anpaizixunupdate.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_anpaizixunshi64"
                                    data-value="${Info.html(mmm.anpaizixunshi)}"
                                ...
                                <script>
                                    $(".class_anpaizixunshi64").val($(".class_anpaizixunshi64").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    name="kaishishijian"
                                    readonly="readonly"
                                    value="${Info.html(mmm.kaishishijian)}"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    name="jieshushijian"
                                    readonly="readonly"
                                    value="${Info.html(mmm.jieshushijian)}"
                                />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_didian65"
                                    data-value="${Info.html(mmm.didian)}"
                                    data-rule-required="true"
                                ...
                                <script>
                                    $(".class_didian65").val($(".class_didian65").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
