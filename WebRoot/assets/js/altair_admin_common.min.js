...
(altair_page_onload = {
    ...
    (altair_main_sidebar = {
        init: function () {
            $sidebar_main.length &&
                ($body.hasClass("sidebar_mini") || null !== localStorage.getItem("altair_sidebar_mini")
                    ...
                    : ($sidebar_main_toggle.on("click", function (e) {
                          e.preventDefault(),
                              $body.hasClass("sidebar_main_active") || ($body.hasClass("sidebar_main_open") && $window.width() >= 1220)
                      ...
                      $document.on("click keyup", function (e) {
                          $body.hasClass("sidebar_main_active") &&
                              $window.width() < 1220 &&
                              ((!$(e.target).closest($sidebar_main).length && !$(e.target).closest($sidebar_main_toggle).length) || 27 == e.keyCode) &&
                              altair_main_sidebar.hide_sidebar();
                      }),
            ...
            $sidebar_secondary.find(".md-list.chat_users").length &&
                ...
                $sidebar_secondary.find(".uk-tab").length &&
                    $sidebar_secondary.find(".uk-tab").on("change.uk.tab", function (e, i, a) {
                        $(i).hasClass("chat_sidebar_tab") && $sidebar_secondary.find(".chat_box_wrapper").hasClass("chat_box_active")
                            ? $sidebar_secondary.addClass("chat_sidebar")
                            : $sidebar_secondary.removeClass("chat_sidebar");
                    }));
        },
            ...
            $("#main_search_btn").on("click", function (e) {
                ...
                $(document).on("click keydown", function (e) {
                    $body.hasClass("main_search_active") &&
                        ((!$(e.target).closest(".header_main_search_form").length && !$(e.target).closest("#main_search_btn").length) || 27 == e.which) &&
    ...
    (altair_md = {
        ...
        update_input: function (e) {
            e.closest(".md-input-wrapper").removeClass("md-input-wrapper-danger md-input-wrapper-success md-input-wrapper-disabled"),
                e.hasClass("md-input-danger") && e.closest(".md-input-wrapper").addClass("md-input-wrapper-danger"),
                e.hasClass("md-input-success") && e.closest(".md-input-wrapper").addClass("md-input-wrapper-success"),
                ...
                var a = isHighDensity() ? "@2x" : "",
                    t =
                        "undefined" != typeof e && "regular" == e
                            ? '<img src="assets/img/spinners/spinner' + a + '.gif" alt="" width="32" height="32">'
