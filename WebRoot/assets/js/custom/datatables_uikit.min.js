!(function (e, t, i) {
    var a = function (e, i) {
        ...
        e.extend(!0, i.defaults, {
            ...
            e.extend(i.ext.classes, { sWrapper: "dataTables_wrapper form-inline dt-uikit", sFilterInput: "md-input", sLengthSelect: "dt-selectize", sPaging: "" }),
                            ...
                            if (((k = i[n]), e.isArray(k))) h(t, k);
                                ...
                                switch (((r = ""), (u = ""), k)) {
                                    ...
                                    case "next":
                                        ...
                                        break;
                                    case "last":
                                        (r = '<i class="uk-icon-angle-double-right"/>'), (u = k + (l - 1 > o ? "" : " uk-disabled"));
                                        break;
                                    default:
                                        (r = k + 1), (u = o === k ? "uk-active" : "");
                                }
                                r &&
                                    ((c = e("<li>", { class: p.sPageButton + " " + u, id: 0 === d && "string" == typeof k ? a.sTableId + "_" + k : null })
                                        .append(e("<a>", { href: "#", "aria-controls": a.sTableId, "data-dt-idx": T, tabindex: a.iTabIndex }).html(r))
                                        .appendTo(t)),
