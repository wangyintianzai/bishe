!(function (e, t) {
        ...
        (i.currentIndex = l),
            s.each(function (a) {
                var i = e(this),
                    ...
                    f = e.extend({}, te, { title: i.html(), content: d === Y.html ? s.html() : "", contentUrl: u, contentMode: d, contentLoaded: c });
                n(r, f);
            });
    }
    function a(e) {
    ...
    function s(t, n) {
        var r = l(t);
        t.unbind(r).removeData("uid").removeData("options").removeData("state").removeData("steps").removeData("eventNamespace").find(".actions a").unbind(r),
            t.removeClass(n.clearFixCssClass + " vertical");
        var a = t.find(".content > *");
        a.removeData("loaded").removeData("mode").removeData("url"),
            a.removeAttr("id").removeAttr("role").removeAttr("tabindex").removeAttr("class").removeAttr("style")._removeAria("labelledby")._removeAria("hidden"),
    ...
    function x(e, t, n, r) {
        if (((0 > r || r >= n.stepCount) && $(J), !(t.forceMoveForward && r < n.currentIndex))) {
    ...
    function y(t) {
        ...
        return this.each(function () {
            var t = e(this),
                a = { currentIndex: n.startIndex, currentStep: null, stepCount: 0, transitionElement: null };
            t.data("options", n),
                t.data("state", a),
                t.data("steps", []),
                r(t, n, a),
                L(t, n, a),
                D(t, n),
                n.autoFocus && 0 === K && d(t, n.startIndex).focus(),
    ...
    function _(t, n, r, a, i) {
        (0 > a || a > r.stepCount) && $(J),
            (i = e.extend({}, te, i)),
            A(t, a, i),
            r.currentIndex !== r.stepCount && r.currentIndex >= a && (r.currentIndex++, j(t, n, r)),
            r.stepCount++;
    ...
    function w(t) {
        ...
        t.keyCode === i.left ? (t.preventDefault(), b(n, r, a)) : t.keyCode === i.right && (t.preventDefault(), C(n, r, a));
    }
    function F(t, n, r) {
        if (r.stepCount > 0) {
                ...
                switch (g(Y, i.contentMode)) {
                    ...
                    case Y.async:
                        var s = u(t, a)
                            ._aria("busy", "true")
                            .empty()
                            .append(H(n.loadingTemplate, { text: n.labels.loading }));
    ...
    function T(e, t, n, r) {
        ...
        if (r >= 0 && r < n.stepCount && !(t.forceMoveForward && r < n.currentIndex)) {
            ...
            return s._enableAria(), i.click(), a === n.currentIndex && o ? (s._enableAria(!1), !1) : !0;
        }
        return !1;
    }
    function k(t) {
    ...
    function S(e, t, n) {
        if (t.enablePagination) {
            ...
            t.enableFinishButton && t.showFinishButtonAlways
                ? (r._enableAria(n.stepCount > 0), a._enableAria(n.stepCount > 1 && n.stepCount > n.currentIndex + 1))
                : (r._showAria(t.enableFinishButton && n.stepCount === n.currentIndex + 1),
                  a._showAria(0 === n.stepCount || n.stepCount > n.currentIndex + 1)._enableAria(n.stepCount > n.currentIndex + 1 || !t.enableFinishButton));
        }
    }
    function q(t, n, r, a) {
    ...
    function E(e, t, n, r) {
        for (var a = m(e), i = r; i < n.stepCount; i++) {
            ...
            e
                ...
                ._aria("controls", o)
                .attr("href", "#" + l)
                .html(H(t.titleTemplate, { index: i + 1, title: d.html() })),
    ...
    function M(e, t, n, r) {
        return 0 > r || r >= n.stepCount || n.currentIndex === r
            ? !1
            : (N(e, r),
              n.currentIndex > r && (n.currentIndex--, j(e, t, n)),
              n.stepCount--,
              c(e, r).remove(),
              u(e, r).remove(),
              d(e, r).parent().remove(),
    ...
    function B(e, t, n) {
        if (t.enablePagination) {
            var r = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
                ...
                i = "";
            t.forceMoveForward || (i += a.format("previous", t.labels.previous)),
                (i += a.format("next", t.labels.next)),
                t.enableFinishButton && (i += a.format("finish", t.labels.finish)),
                t.enableCancelButton && (i += a.format("cancel", t.labels.cancel)),
                e.append(r.format(t.actionContainerTag, t.clearFixCssClass, t.labels.pagination, i)),
                S(e, t, n),
                F(e, t, n);
        }
    }
    ...
    function P(t, n, r, a, i) {
        var s = m(t),
            ...
            u = s + G + i,
            c = t.find(".steps > ul"),
            f = H(n.titleTemplate, { index: i + 1, title: a.html() }),
            p = e('<li role="tab"><a id="' + o + '" href="#' + u + '" aria-controls="' + d + '">' + f + "</a></li>");
        p._enableAria(n.enableAllSteps || r.currentIndex > i),
            ...
            i === r.stepCount - 1 && c.find("li").removeClass("last").eq(i).addClass("last"),
            p.children("a").bind("click" + l(t), z);
    }
    function j(t, n, r) {
                ...
                (r.transitionElement = u),
                    c[f](d, function () {
                        var t = e(this)._showAria(!1).parent().parent(),
                            n = p(t);
                        n.transitionElement &&
                            (n.transitionElement[h](d, function () {
                                e(this)._showAria();
                            })
                                .promise()
                                .done(s),
    ...
    var Y = (e.fn.steps.contentMode = { html: 0, iframe: 1, async: 2 }),
        ...
        ee = (e.fn.steps.transitionEffect = { none: 0, fade: 1, slide: 2, slideLeft: 3 }),
        te = (e.fn.steps.stepModel = { title: "", content: "", contentUrl: "", contentMode: Y.html, contentLoaded: !1 }),
