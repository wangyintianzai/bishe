            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_zhuangtai30" data-value="${param.zhuangtai}" id="zhuangtai" name="zhuangtai">
                        ...
                        <script>
                            $(".class_zhuangtai30").val($(".class_zhuangtai30").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        初访结论

                        <select class="form-control class_chufangjielun31" data-value="${param.chufangjielun}" id="chufangjielun" name="chufangjielun">
                            <option value="">请选择</option>
                        ...
                        <script>
                            $(".class_chufangjielun31").val($(".class_chufangjielun31").attr("data-value"));
                        </script>
                    </div>
