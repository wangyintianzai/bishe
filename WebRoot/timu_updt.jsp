...
${Info.html(mmm.biaoti)}</textarea
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_leixing37" data-value="${Info.html(mmm.leixing)}" id="leixing" name="leixing" style="width: 250px">
                                    <option value="单选题">单选题</option>
                                    <option value="多选题">多选题</option>
                                </select>
                                <script>
                                    $(".class_leixing37").val($(".class_leixing37").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
