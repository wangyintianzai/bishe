...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">添加值班信息:</div>
            <div class="panel-body">
                <form action="zhibanxinxiinsert.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-inline">
                                    ...
                                    <select class="form-control class_zhiwei_search22" data-value="" id="zhiwei_search" name="zhiwei_search">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control select-update" placeholder="输入工号" style="width: 150px" id="gonghao" name="gonghao" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control select-update" data-value="初访员" id="zhiwei" name="zhiwei" style="width: 250px">
                                    <option value="咨询师">咨询师</option>
                                    <option value="初访员">初访员</option>
                                </select>
                                <script>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_xingqiji24"
                                    data-value=""
