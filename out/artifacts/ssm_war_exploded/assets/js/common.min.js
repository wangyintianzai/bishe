!(function (e, t) {
    ...
    function w(t, n) {
        var i,
            r = J(n.createElement(t)).appendTo(n.body),
    ...
    function b(e) {
        ...
        return (
            n ||
                ((n = w(e, t)),
                ("none" !== n && n) ||
                    (($e = ($e || J("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement)),
    ...
    function T(e, t, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2)
            "margin" === n && (s += J.css(e, n + Se[o], !0, r)),
                i
                    ? ("content" === n && (s -= J.css(e, "padding" + Se[o], !0, r)), "margin" !== n && (s -= J.css(e, "border" + Se[o] + "Width", !0, r)))
                    : ((s += J.css(e, "padding" + Se[o], !0, r)), "padding" !== n && (s += J.css(e, "border" + Se[o] + "Width", !0, r)));
        return s;
    }
        ...
        for (var n, i, r, o = [], s = 0, a = e.length; a > s; s++)
            (i = e[s]),
                i.style &&
                    ...
                    (n = i.style.display),
                    t
                        ? (o[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && ke(i) && (o[s] = ve.access(i, "olddisplay", b(i.nodeName))))
                        : ((r = ke(i)), ("none" === n && r) || ve.set(i, "olddisplay", r ? n : J.css(i, "display"))));
    ...
    function M(e, t, n) {
        ...
        n.queue ||
            ...
            1 === e.nodeType &&
                ...
                (u = J.css(e, "display")),
                (c = "none" === u ? ve.get(e, "olddisplay") || b(e.nodeName) : u),
                "inline" === c && "none" === J.css(e, "float") && (f.display = "inline-block")),
            n.overflow &&
                ((f.overflow = "hidden"),
                d.always(function () {
    ...
    function F(e, t, n) {
        var i,
            ...
            l = function () {
                if (r) return !1;
                for (var t = Ze || D(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, s = 0, l = u.tweens.length; l > s; s++)
                    u.tweens[s].run(o);
        ...
        (J.extend = J.fn.extend =
            function () {
                var e,
                    ...
                    u = !1;
                for (
                    "boolean" == typeof s && ((u = s), (s = arguments[a] || {}), a++), "object" == typeof s || J.isFunction(s) || (s = {}), a === l && ((s = this), a--);
                    l > a;
                    a++
                )
                            ...
                            (n = s[t]),
                                ...
                                s !== i &&
                                    (u && i && (J.isPlainObject(i) || (r = J.isArray(i)))
                                        ? (r ? ((r = !1), (o = n && J.isArray(n) ? n : [])) : (o = n && J.isPlainObject(n) ? n : {}), (s[t] = J.extend(u, o, i)))
                                        : void 0 !== i && (s[t] = i));
                return s;
            }),
        J.extend({
    ...
    var re = (function (e) {
        function t(e, t, n, i) {
            ...
            if (((t ? t.ownerDocument || t : z) !== M && A(t), (t = t || M), (n = n || []), (a = t.nodeType), "string" != typeof e || !e || (1 !== a && 9 !== a && 11 !== a)))
                return n;
            if (!i && F) {
                if (11 !== a && (r = ye.exec(e)))
                    if ((s = r[1])) {
                ...
                if (x.qsa && (!I || !I.test(e))) {
                    if (((f = d = $), (h = t), (g = 1 !== a && e), 1 === a && "object" !== t.nodeName.toLowerCase())) {
                        for (u = T(e), (d = t.getAttribute("id")) ? (f = d.replace(be, "\\$&")) : t.setAttribute("id", f), f = "[id='" + f + "'] ", l = u.length; l--; )
                            u[l] = f + p(u[l]);
            ...
            for (
                ...
                if ((n = S.relative[e[a].type])) c = [f(h(c), n)];
                    ...
                    if (((n = S.filter[e[a].type].apply(null, e[a].matches)), n[$])) {
                        ...
                        return v(
                            a > 1 && h(c),
                            a > 1 && p(e.slice(0, a - 1).concat({ value: " " === e[a - 2].type ? "*" : "" })).replace(le, "$1"),
                            n,
                            i > a && y(e.slice(a, i)),
                            r > i && y((e = e.slice(i))),
                            r > i && p(e)
        ...
        (x = t.support = {}),
                ...
                function (e) {
                    ...
                    return i !== M && 9 === i.nodeType && i.documentElement
                        ? ((M = i),
                          ...
                          (x.qsa = ve.test(i.querySelectorAll)) &&
                              (r(function (e) {
                                  (N.appendChild(e).innerHTML = "<a id='" + $ + "'></a><select id='" + $ + "-\f]' msallowcapture=''><option selected=''></option></select>"),
                                      ...
                                      e.querySelectorAll("[id~=" + $ + "-]").length || I.push("~="),
                                      e.querySelectorAll(":checked").length || I.push(":checked"),
                                      e.querySelectorAll("a#" + $ + "+*").length || I.push(".#.+[+~]");
                              }),
                              r(function (e) {
                          ...
                          (x.matchesSelector = ve.test((j = N.matches || N.webkitMatchesSelector || N.mozMatchesSelector || N.oMatchesSelector || N.msMatchesSelector))) &&
                              r(function (e) {
                                    ...
                                    return n
                                        ...
                                        : ((n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1),
                                          1 & n || (!x.sortDetached && t.compareDocumentPosition(e) === n)
                                              ? e === i || (e.ownerDocument === z && Y(z, e))
                                                  ? -1
                                                  : t === i || (t.ownerDocument === z && Y(z, t))
                                                  ? 1
                                                  : D
                                                  ? ee(D, e) - ee(D, t)
                                                  : 0
            ...
            (t.matchesSelector = function (e, n) {
                if (((e.ownerDocument || e) !== M && A(e), (n = n.replace(de, "='$1']")), x.matchesSelector && F && (!L || !L.test(n)) && (!I || !I.test(n))))
                    try {
                        var i = j.call(e, n);
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function (e) {
                            ...
                            return he.CHILD.test(e[0])
                                ...
                                : (e[3]
                                      ? (e[2] = e[4] || e[5] || "")
                                      : n && pe.test(n) && (t = T(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))),
                                  e.slice(0, 3));
                        },
                    },
                    filter: {
                                ...
                                : function (t, n, l) {
                                      ...
                                      if (m) {
                                          ...
                                          if (((h = [s ? m.firstChild : m.lastChild]), s && y)) {
                                              for (
                                                  c = m[$] || (m[$] = {}), u = c[e] || [], f = u[0] === H && u[1], p = u[0] === H && u[2], d = f && m.childNodes[f];
                                              ...
                                              for (
                                                  ;
                                                  (d = (++f && d && d[g]) || (p = f = 0) || h.pop()) &&
                                                  ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++p || (y && ((d[$] || (d[$] = {}))[e] = [H, p]), d !== t));
            ...
            (T = t.tokenize =
                function (e, n) {
                    ...
                    for (a = e, l = [], u = S.preFilter; a; ) {
                        (!i || (r = ue.exec(a))) && (r && (a = a.slice(r[0].length) || a), l.push((o = []))),
                            (i = !1),
                            (r = ce.exec(a)) &&
                                ((i = r.shift()),
                                o.push({
            ...
            function (e, t) {
                J.fn[e] = function (n, i) {
                    ...
                    return (
                        ...
                        this.length > 1 && (pe[e] || J.unique(r), de.test(e) && r.reverse()),
                        this.pushStack(r)
                    );
                };
            }
            ...
            when: function (e) {
                ...
                if (s > 1)
                    for (t = new Array(s), n = new Array(s), i = new Array(s); s > r; r++)
                        o[r] && J.isFunction(o[r].promise) ? o[r].promise().done(u(r, i, o)).fail(l.reject).progress(u(r, n, t)) : --a;
        ...
        J.extend({
            ...
            ready: function (e) {
                (e === !0 ? --J.readyWait : J.isReady) ||
                    ((J.isReady = !0), (e !== !0 && --J.readyWait > 0) || (ge.resolveWith(Q, [J]), J.fn.triggerHandler && (J(Q).triggerHandler("ready"), J(Q).off("ready"))));
            },
        }),
        (J.ready.promise = function (t) {
            return (
                ge || ((ge = J.Deferred()), "complete" === Q.readyState ? setTimeout(J.ready) : (Q.addEventListener("DOMContentLoaded", s, !1), e.addEventListener("load", s, !1))),
                ge.promise(t)
            );
        }),
        J.ready.promise();
        ...
        (a.prototype = {
            ...
            remove: function (e, t) {
                ...
                if (void 0 === t) this.cache[o] = {};
                    ...
                    J.isArray(t) ? (i = t.concat(t.map(J.camelCase))) : ((r = J.camelCase(t)), t in s ? (i = [t, r]) : ((i = r), (i = i in s ? [i] : i.match(fe) || []))),
                        (n = i.length);
                    for (; n--; ) delete s[i[n]];
                }
            },
    ...
    (J.event = {
                ...
                for (
                    ...
                    (a = De.exec(t[u]) || []),
                        ...
                        f &&
                            ...
                            (p = l[f]) ||
                                ((p = l[f] = []), (p.delegateCount = 0), (d.setup && d.setup.call(e, i, h, s) !== !1) || (e.addEventListener && e.addEventListener(f, s, !1))),
            ...
            if (
                ...
                for (o = 0; (s = p[o++]) && !t.isPropagationStopped(); )
                    (t.type = o > 1 ? l : d.bindType || f),
                        ...
                        c && c.apply(s, n),
                        (c = u && s[u]),
                        c && c.apply && J.acceptData(s) && ((t.result = c.apply(s, n)), t.result === !1 && t.preventDefault());
                return (
                    (t.type = f),
                    r ||
        ...
        dispatch: function (e) {
            ...
            if (((a[0] = e), (e.delegateTarget = this), !u.preDispatch || u.preDispatch.call(this, e) !== !1)) {
                for (s = J.event.handlers.call(this, e, l), t = 0; (r = s[t++]) && !e.isPropagationStopped(); )
                    for (e.currentTarget = r.elem, n = 0; (o = r.handlers[n++]) && !e.isImmediatePropagationStopped(); )
                        (!e.namespace_re || e.namespace_re.test(o.namespace)) &&
                            ((e.handleObj = o),
                            (e.data = o.data),
                            (i = ((J.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, a)),
        ...
        fix: function (e) {
            ...
            var t,
                ...
                s = this.fixHooks[r];
            for (
                s || (this.fixHooks[r] = s = Ee.test(r) ? this.mouseHooks : _e.test(r) ? this.keyHooks : {}),
            ...
            return this instanceof J.Event
                ? (e && e.type
                      ? ((this.originalEvent = e),
                        (this.type = e.type),
                        (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && e.returnValue === !1) ? u : c))
                      : (this.type = e),
                  t && J.extend(this, t),
        ...
        J.fn.extend({
            on: function (e, t, n, i, r) {
                ...
                if (
                    (null == n && null == i ? ((i = t), (n = t = void 0)) : null == i && ("string" == typeof t ? ((i = n), (n = void 0)) : ((i = n), (n = t), (t = void 0))),
                    i === !1)
                )
                    i = c;
            ...
            buildFragment: function (e, t, n, i) {
                        ...
                        if ("object" === J.type(r)) J.merge(d, r.nodeType ? [r] : r);
                            ...
                            for (
                                o = o || c.appendChild(t.createElement("div")),
                                    s = (Ae.exec(r) || ["", ""])[1].toLowerCase(),
                                    a = Ye[s] || Ye._default,
                                    o.innerHTML = a[1] + r.replace(Pe, "<$1></$2>") + a[2],
                                    u = a[0];
                                u--;
                ...
                for (c.textContent = "", p = 0; (r = d[p++]); )
                    if ((!i || -1 === J.inArray(r, i)) && ((l = J.contains(r.ownerDocument, r)), (o = v(c.appendChild(r), "script")), l && g(o), n))
                        for (u = 0; (r = o[u++]); ) Ie.test(r.type || "") && n.push(r);
                return c;
            },
        ...
        J.fn.extend({
            ...
            remove: function (e, t) {
                for (var n, i = e ? J.filter(e, this) : this, r = 0; null != (n = i[r]); r++)
                    t || 1 !== n.nodeType || J.cleanData(v(n)), n.parentNode && (t && J.contains(n.ownerDocument, n) && g(v(n, "script")), n.parentNode.removeChild(n));
                return this;
            },
            empty: function () {
            ...
            domManip: function (e, t) {
                ...
                var n,
                    ...
                    p = e[0],
                    g = J.isFunction(p);
                if (g || (u > 1 && "string" == typeof p && !Z.checkClone && Fe.test(p)))
                ...
                if (u && ((n = J.buildFragment(e, this[0].ownerDocument, !1, this)), (i = n.firstChild), 1 === n.childNodes.length && (n = i), i)) {
                    for (r = J.map(v(n, "script"), f), o = r.length; u > l; l++)
                        (s = n), l !== d && ((s = J.clone(s, !0, !0)), o && J.merge(r, v(s, "script"))), t.call(this[l], s, l);
                    if (o)
                        for (a = r[r.length - 1].ownerDocument, J.map(r, h), l = 0; o > l; l++)
                            (s = r[l]),
                                Ie.test(s.type || "") &&
                                    !ve.access(s, "globalEval") &&
                                    J.contains(a, s) &&
                                    (s.src ? J._evalUrl && J._evalUrl(s.src) : J.globalEval(s.textContent.replace(je, "")));
                }
                return this;
            },
        }),
    ...
    J.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r,
                    ...
                    l = e.style;
                return (
                    (t = J.cssProps[a] || (J.cssProps[a] = k(l, a))),
                    ...
                    void 0 === n
                        ? s && "get" in s && void 0 !== (r = s.get(e, !1, i))
                            ...
                            : l[t]
                        : ((o = typeof n),
                          "string" === o && (r = Xe.exec(n)) && ((n = (r[1] + 1) * r[2] + parseFloat(J.css(e, t))), (o = "number")),
                          null != n &&
                              n === n &&
        ...
        css: function (e, t, n, i) {
            var r,
                ...
                a = J.camelCase(t);
            return (
                (t = J.cssProps[a] || (J.cssProps[a] = k(e.style, a))),
                (s = J.cssHooks[t] || J.cssHooks[a]),
                s && "get" in s && (r = s.get(e, !0, n)),
                void 0 === r && (r = x(e, t, i)),
                "normal" === r && t in Ue && (r = Ue[t]),
                "" === n || n ? ((o = parseFloat(r)), n === !0 || J.isNumeric(o) ? o || 0 : r) : r
            );
        },
    }),
        J.each(["height", "width"], function (e, t) {
            J.cssHooks[t] = {
                get: function (e, n, i) {
                    return n
                        ? Re.test(J.css(e, "display")) && 0 === e.offsetWidth
                            ? J.swap(e, Be, function () {
                                  return _(e, t, i);
                              })
                            : _(e, t, i)
                        : void 0;
                ...
                return (
                    ...
                    this.each(function () {
                        var t,
                            ...
                            o = J.timers,
                            s = i ? i.length : 0;
                        for (n.finish = !0, J.queue(this, e, []), r && r.stop && r.stop.call(this, !0), t = o.length; t--; )
            ...
            attr: function (e, t, n) {
                ...
                if (e && 3 !== o && 8 !== o && 2 !== o)
                    return typeof e.getAttribute === Te
                        ? J.prop(e, t, n)
                        : ((1 === o && J.isXMLDoc(e)) || ((t = t.toLowerCase()), (i = J.attrHooks[t] || (J.expr.match.bool.test(t) ? rt : it))),
                          void 0 === n
                              ? i && "get" in i && null !== (r = i.get(e, t))
                                  ? r
                                  : ((r = J.find.attr(e, t)), null == r ? void 0 : r)
                              : null !== n
        ...
        J.extend({
            ...
            prop: function (e, t, n) {
                ...
                if (e && 3 !== s && 8 !== s && 2 !== s)
                    return (
                        (o = 1 !== s || !J.isXMLDoc(e)),
                        o && ((t = J.propFix[t] || t), (r = J.propHooks[t])),
                ...
                r = this[0];
            {
                if (arguments.length)
                    return (
                        ...
                        this.each(function (n) {
                            var r;
                            1 === this.nodeType &&
                                ((r = i ? e.call(this, n, J(this).val()) : e),
                                null == r
                                    ? (r = "")
                                    : "number" == typeof r
                                    ? (r += "")
                ...
                if (r)
                    return (
                        ...
                        t && "get" in t && void 0 !== (n = t.get(r, "value")) ? n : ((n = r.value), "string" == typeof n ? n.replace(lt, "") : null == n ? "" : n)
                    );
            }
        },
    }),
                    ...
                    get: function (e) {
                        for (
                            ...
                            if (
                                ((n = i[l]),
                                (n.selected || l === r) &&
                                    (Z.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) &&
    ...
    J.extend({
        ...
        ajax: function (e, t) {
            function n(e, t, n, s) {
                ...
                2 !== w &&
                    ...
                    (y = $(d, y, x, l)),
                    l
                        ? (d.ifModified && ((b = x.getResponseHeader("Last-Modified")), b && (J.lastModified[r] = b), (b = x.getResponseHeader("etag")), b && (J.etag[r] = b)),
                          204 === e || "HEAD" === d.type ? (S = "nocontent") : 304 === e ? (S = "notmodified") : ((S = y.state), (c = y.data), (v = y.error), (l = !v)))
                        : ((v = S), (e || !S) && ((S = "error"), 0 > e && (e = 0))),
                    (x.status = e),
                    (x.statusText = (t || S) + ""),
                    l ? h.resolveWith(p, [c, S, x]) : h.rejectWith(p, [x, S, v]),
                    x.statusCode(m),
                    (m = void 0),
                    u && f.trigger(l ? "ajaxSuccess" : "ajaxError", [x, d, l ? c : v]),
                    g.fireWith(p, [x, S]),
                    u && (f.trigger("ajaxComplete", [x, d]), --J.active || J.event.trigger("ajaxStop")));
            }
            ...
            if (
                ...
                (x.success = x.done),
                (x.error = x.fail),
                (d.url = ((e || d.url || xt) + "").replace(dt, "").replace(mt, St[1] + "//")),
            ...
            (u = J.event && d.global),
                ...
                (r = d.url),
                d.hasContent ||
                    (d.data && ((r = d.url += (ct.test(r) ? "&" : "?") + d.data), delete d.data),
                    d.cache === !1 && (d.url = pt.test(r) ? r.replace(pt, "$1_=" + ut++) : r + (ct.test(r) ? "&" : "?") + "_=" + ut++)),
                d.ifModified && (J.lastModified[r] && x.setRequestHeader("If-Modified-Since", J.lastModified[r]), J.etag[r] && x.setRequestHeader("If-None-Match", J.etag[r])),
        ...
        J.each(["get", "post"], function (e, t) {
            J[t] = function (e, n, i, r) {
                return (
                    J.isFunction(n) && ((r = r || i), (i = n), (n = void 0)),
                    J.ajax({
                        url: e,
                        type: t,
                        dataType: r,
    ...
    e.attachEvent &&
        ...
        (Z.cors = !!At && "withCredentials" in At),
        (Z.ajax = At = !!At),
                                  ...
                                  t &&
                                      ...
                                      "abort" === e
                                          ...
                                          : i(
                                                ...
                                                o.statusText,
                                                "string" == typeof o.responseText ? { text: o.responseText } : void 0,
    ...
    J.ajaxSetup({
        ...
        J.ajaxPrefilter("json jsonp", function (t, n, i) {
            var r,
                ...
                a =
                    t.jsonp !== !1 &&
                    (Nt.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && Nt.test(t.data) && "data");
            return a || "jsonp" === t.dataTypes[0]
                ? ((r = t.jsonpCallback = J.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
                  a ? (t[a] = t[a].replace(Nt, "$1" + r)) : t.jsonp !== !1 && (t.url += (ct.test(t.url) ? "&" : "?") + t.jsonp + "=" + r),
    ...
    (J.fn.load = function (e, t, n) {
        ...
        return (
            ...
            J.isFunction(t) ? ((n = t), (t = void 0)) : t && "object" == typeof t && (r = "POST"),
            s.length > 0 &&
                J.ajax({
                    url: e,
                    type: r,
    ...
    (window.Modernizr = (function (e, t, n) {
                        ...
                        b.setAttribute("type", (r = e[s])),
                            ...
                            i &&
                                ...
                                /^range$/.test(r) && b.style.WebkitAppearance !== n
                                    ? (m.appendChild(b),
                                      (o = t.defaultView),
                                      (i = o.getComputedStyle && "textfield" !== o.getComputedStyle(b, null).WebkitAppearance && 0 !== b.offsetHeight),
                                      m.removeChild(b))
                                    : /^(search|tel)$/.test(r) || (i = /^(url|email)$/.test(r) ? b.checkValidity && b.checkValidity() === !1 : b.value != x)),
                            (D[e[s]] = !!i);
                    return D;
        ...
        var d,
            ...
            F = function (t) {
                ...
                var i;
                return (
                    N("@media " + t + " { #" + v + " { position: absolute; } }", function (t) {
                ...
                function e(e, r) {
                    ...
                    return (
                        s ||
                            ...
                            r.setAttribute && r.removeAttribute && (r.setAttribute(e, ""), (s = o(r[e], "function")), o(r[e], "undefined") || (r[e] = n), r.removeAttribute(e))),
                        (r = null),
                        s
                    );
                }
        ...
        (p =
            ...
            (O.touch = function () {
                ...
                return (
                    "ontouchstart" in e || (e.DocumentTouch && t instanceof DocumentTouch)
                        ? (n = !0)
                        : N(["@media (", k.join("touch-enabled),("), v, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function (e) {
                              n = 9 === e.offsetTop;
                          }),
                    n
                );
            ...
            (O.csstransforms3d = function () {
                ...
                return (
                    e &&
                        ...
                        N("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function (t, n) {
            ...
            (O.fontface = function () {
                var e;
                return (
                    N('@font-face {font-family:"font";src:url("https://")}', function (n, i) {
            ...
            (O.generatedcontent = function () {
                var e;
                return (
                    N(["#", v, "{font:0/0 a}#", v, ':after{content:"', x, '";visibility:hidden;font:3px/1 a}'].join(""), function (t) {
                        e = t.offsetHeight >= 3;
                    }),
                    e
                );
        ...
        return (
            ...
            (function (e, t) {
                ...
                function o(e, n, i) {
                    ...
                    var o;
                    return (
                        (o = i.cache[e] ? i.cache[e].cloneNode() : h.test(e) ? (i.cache[e] = i.createElem(e)).cloneNode() : i.createElem(e)),
            ...
            (m.className = m.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (g ? " js " + A.join(" ") : "")),
            h
        );
    })(this, this.document)),
    (function (e, t) {
        ...
        function p(e, t) {
            ...
            if (
                ...
                "undefined" != typeof t._pf && (e._pf = u(t)),
        ...
        function x(e) {
            var t = null;
            if (!Yn[e] && "undefined" != typeof module && module && module.exports)
                try {
        ...
        function G(e, t) {
            ...
            return "string" == typeof t && ((t = e.localeData().monthsParse(t)), "number" != typeof t)
                ? e
                : ((n = Math.min(e.date(), V(e.year(), t))), e._d["set" + (e._isUTC ? "UTC" : "") + "Month"](t, n), e);
        }
            ...
            return (
                n &&
                    ...
                    ((t =
                        n[ai] < 0 || n[ai] > 11
                            ? ai
                            : n[li] < 1 || n[li] > V(n[si], n[ai])
                            ? li
                            : n[ui] < 0 || n[ui] > 24 || (24 === n[ui] && (0 !== n[ci] || 0 !== n[di] || 0 !== n[pi]))
                            ? ui
                            : n[ci] < 0 || n[ci] > 59
                            ? ci
                            : n[di] < 0 || n[di] > 59
                            ...
                            ? pi
                            : -1),
                    u(e)._overflowDayOfYear && (si > t || t > li) && (t = li),
                    (u(e).overflow = t)),
                e
            );
        }
        ...
        function we(e) {
            ...
            if (!e._d) {
                for (
                    i = ye(e),
                        e._w && null == e._a[li] && null == e._a[ai] && be(e),
                        e._dayOfYear &&
                            ((r = ve(e._a[si], i[si])),
                            e._dayOfYear > se(r) && (u(e)._overflowDayOfYear = !0),
                            (n = oe(r, 0, e._dayOfYear)),
                            (e._a[ai] = n.getUTCMonth()),
                ...
                24 === e._a[ui] && 0 === e._a[ci] && 0 === e._a[di] && 0 === e._a[pi] && ((e._nextDay = !0), (e._a[ui] = 0)),
        ...
        function be(e) {
            ...
            (t = e._w),
                null != t.GG || null != t.W || null != t.E
                    ? ((o = 1), (s = 4), (n = ve(t.GG, e._a[si], ue(De(), 1, 4).year)), (i = ve(t.W, 1)), (r = ve(t.E, 1)))
                    : ((o = e._locale._week.dow),
                      (s = e._locale._week.doy),
                      (n = ve(t.gg, e._a[si], ue(De(), o, s).year)),
                      (i = ve(t.w, 1)),
                      null != t.d ? ((r = t.d), o > r && ++i) : (r = null != t.e ? t.e + o : o)),
                (a = ge(n, i, r, s, o)),
                (e._a[si] = a.year),
        ...
        function xe(t) {
            ...
            var n,
                ...
                l = a.length,
                c = 0;
            for (r = j(t._f, t._locale).match(zn) || [], n = 0; n < r.length; n++)
                (o = r[n]),
                    (i = (a.match(z(o, t)) || [])[0]),
                    i && ((s = a.substr(0, a.indexOf(i))), s.length > 0 && u(t).unusedInput.push(s), (a = a.slice(a.indexOf(i) + i.length)), (c += i.length)),
                    Wn[o] ? (i ? (u(t).empty = !1) : u(t).unusedTokens.push(o), R(o, i, t)) : t._strict && !i && u(t).unusedTokens.push(o);
            (u(t).charsLeftOver = l - c),
                a.length > 0 && u(t).unusedInput.push(a),
                u(t).bigHour === !0 && t._a[ui] <= 12 && t._a[ui] > 0 && (u(t).bigHour = void 0),
                (t._a[ui] = Se(t._locale, t._a[ui], t._meridiem)),
                we(t),
                K(t);
        }
        ...
        function ke(e) {
            ...
            for (r = 0; r < e._f.length; r++)
                (o = 0),
                    ...
                    (t._f = e._f[r]),
                    xe(t),
                    c(t) && ((o += u(t).charsLeftOver), (o += 10 * u(t).unusedTokens.length), (u(t).score = o), (null == i || i > o) && ((i = o), (n = t)));
            s(e, n || t);
        }
        ...
        function Oe(e, t, n, i, r) {
            var o = {};
            return (
                "boolean" == typeof n && ((i = n), (n = void 0)), (o._isAMomentObject = !0), (o._useUTC = o._isUTC = r), (o._l = n), (o._i = e), (o._f = t), (o._strict = i), Te(o)
            );
        }
        ...
        function $e(t, n) {
            ...
            return null != t
                ? ("string" == typeof t && (t = Le(t)),
                  ...
                  !this._isUTC && n && (i = Ye(this)),
                  (this._offset = t),
                  (this._isUTC = !0),
                  null != i && this.add(i, "m"),
                  r !== t &&
                      (!n || this._changeInProgress
                          ? tt(this, Ze(t - r, "m"), 1, !1)
        ...
        function Ze(e, t) {
            ...
            return (
                Fe(e)
                    ...
                    : null == s
                    ? (s = {})
                    : "object" == typeof s && ("from" in s || "to" in s) && ((r = Je(De(s.from), De(s.to))), (s = {}), (s.ms = r.milliseconds), (s.M = r.months)),
                (i = new Ne(s)),
                Fe(e) && o(e, "_locale") && (i._locale = e._locale),
                i
            );
        }
        ...
        function et(e, t) {
            return function (n, i) {
                ...
                return (
                    null === i ||
                        isNaN(+i) ||
                        (te(t, "moment()." + t + "(period, number) is deprecated. Please use moment()." + t + "(number, period)."), (o = n), (n = i), (i = o)),
        ...
        function rt(e, t) {
            var n;
            return (
                (t = _("undefined" != typeof t ? t : "millisecond")),
                "millisecond" === t ? ((e = h(e) ? e : De(e)), +this > +e) : ((n = h(e) ? +e : +De(e)), n < +this.clone().startOf(t))
            );
        }
        ...
        function ot(e, t) {
            ...
            return (
                (t = _("undefined" != typeof t ? t : "millisecond")),
                "millisecond" === t ? ((e = h(e) ? e : De(e)), +e > +this) : ((n = h(e) ? +e : +De(e)), +this.clone().endOf(t) < n)
            );
        }
        ...
        function at(e, t) {
            ...
            return (
                (t = _(t || "millisecond")),
                "millisecond" === t ? ((e = h(e) ? e : De(e)), +this === +e) : ((n = +De(e)), +this.clone().startOf(t) <= n && n <= +this.clone().endOf(t))
            );
        }
        ...
        function lt(e, t, n) {
            ...
            return (
                ...
                "year" === t || "month" === t || "quarter" === t
                    ? ((r = ut(this, o)), "quarter" === t ? (r /= 3) : "year" === t && (r /= 12))
                    : ((i = this - o),
        ...
        function gn() {
            var e = this._data;
            return (
                (this._milliseconds = Gi(this._milliseconds)),
        ...
        function bn() {
            var e,
                ...
                l = this._data;
            return (
                (o >= 0 && s >= 0 && a >= 0) || (0 >= o && 0 >= s && 0 >= a) || ((o += 864e5 * wn(Sn(a) + s)), (s = 0), (a = 0)),
        ...
        (zi.add = Ei),
            ...
            (zi.weekYear = At),
            (zi.isoWeekYear = Mt),
            (zi.quarter = zi.quarters = It),
            (zi.month = Z),
            (zi.daysInMonth = Q),
            (zi.week = zi.weeks = fe),
            (zi.isoWeek = zi.isoWeeks = he),
            (zi.weeksInYear = Ft),
            (zi.isoWeeksInYear = Nt),
            (zi.date = Pi),
            (zi.day = zi.days = Ht),
            (zi.weekday = qt),
            (zi.isoWeekday = Wt),
            (zi.dayOfYear = me),
            (zi.hour = zi.hours = Ii),
            (zi.minute = zi.minutes = Li),
            (zi.second = zi.seconds = ji),
            (zi.millisecond = zi.milliseconds = $i),
            (zi.utcOffset = $e),
            (zi.utc = He),
            (zi.local = qe),
            (zi.parseZone = We),
            (zi.hasAlignedHourOffset = Re),
            (zi.isDST = Ve),
            (zi.isDSTShifted = Xe),
            (zi.isLocal = Be),
            (zi.isUtcOffset = Ue),
            ...
            (zi.zoneAbbr = Gt),
            (zi.zoneName = Zt),
            (zi.dates = ee("dates accessor is deprecated. Use date instead.", Pi)),
            (zi.months = ee("months accessor is deprecated. Use month instead", Z)),
            (zi.years = ee("years accessor is deprecated. Use year instead", bi)),
            (zi.zone = ee("moment().zone is deprecated, use moment().utcOffset instead. https://github.com/moment/moment/issues/1779", ze));
        var Hi = zi,
            qi = {
                sameDay: "[Today at] LT",
        ...
        (Ui._calendar = qi),
            (Ui.calendar = Jt),
            (Ui._longDateFormat = Wi),
            (Ui.longDateFormat = en),
            (Ui._invalidDate = Ri),
            (Ui.invalidDate = tn),
            (Ui._ordinal = Vi),
            (Ui.ordinal = nn),
            ...
            (Ui._weekdaysMin = Ni),
            (Ui.weekdaysShort = Yt),
            (Ui._weekdaysShort = Mi),
            (Ui.weekdaysParse = zt),
            (Ui.isPM = Xt),
            (Ui._meridiemParse = Fi),
            (Ui.meridiem = Bt),
            S("en", {
            ...
            (e.lang = ee("moment.lang is deprecated. Use moment.locale instead.", S)),
        ...
        (hr.abs = gn),
            ...
            (hr.locale = vt),
            (hr.localeData = yt),
            (hr.toIsoString = ee("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Nn)),
            (hr.lang = Di),
            N("X", 0, 0, "unix"),
            N("x", 0, 0, "valueOf"),
            $("x", ei),
                            ...
                            (u = c.replace(o, function (e) {
                                ...
                                (d =
                                    ...
                                    (s.ping === !0 ||
                                        ...
                                        0 === u.indexOf(document.location.protocol + "//" + document.domain)));
                        }
                        (l = function () {
                            var e = function () {
                            ...
                            a.attr("src", u),
                                "update" === s.dimensions
                                    ...
                                    : ("remove" === s.dimensions && a.removeAttr("width height"), e());
                        }),
                            d
    ...
    (function () {
        ...
        function e(t, i) {
            ...
            if (
                ...
                for (var s = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], a = this, l = 0, u = s.length; u > l; l++)
                    a[s[l]] = r(a[s[l]], a);
        ...
        (e.prototype.needsClick = function (e) {
            ...
            (e.prototype.onTouchMove = function (e) {
                return this.trackingClick
                    ? ((this.targetElement !== this.getTargetElementFromEventTarget(e.target) || this.touchHasMoved(e)) && ((this.trackingClick = !1), (this.targetElement = null)),
                      !0)
                    : !0;
            }),
            ...
            (e.prototype.onTouchEnd = function (e) {
                ...
                return i && !r && ((l = c.fastClickScrollParent), l && l.fastClickLastScrollTop !== l.scrollTop)
                    ? !0
            ...
            (e.notNeeded = function (e) {
                ...
                return "none" === e.style.msTouchAction || "manipulation" === e.style.touchAction
                    ...
                    : ((o = +(/Firefox\/([0-9]+)/.exec(navigator.userAgent) || [, 0])[1]),
                      ...
                      t && (-1 !== t.content.indexOf("user-scalable=no") || document.documentElement.scrollWidth <= window.outerWidth))
                          ? !0
        ...
        a.prototype = {
            ...
            init: function (t) {
                    ...
                    if (
                        ((this.wrapper = c =
                            e("<div>")
                                ...
                                .insertBefore(r)
                                .append(r)),
                        r.is("textarea") && ((this.containerWrapper = s = e("<div>").insertBefore(r).append(r)), c.addClass("scroll-textarea")),
                ...
                e.each(u, function (t, o) {
                        ...
                        o.scroll.find(".scroll-arrow, .scroll-element_track").on("mousedown" + a, function (i) {
                            ...
                            return (
                                e(this).hasClass("scroll-arrow")
                                    ? ((c = e(this).hasClass("scroll-arrow_more") ? 1 : -1), (p = l.scrollStep * c), (h = c > 0 ? a.maxScrollValue : 0))
                                    : ((c = a.eventOffset > a.scrollbarOffset + a.scrollbarSize ? 1 : a.eventOffset < a.scrollbarOffset ? -1 : 0),
                                      (p = Math.round(0.75 * o.visible) * c),
                                      (h = a.eventOffset - a.scrollbarOffset - (l.stepScrolling ? (1 == c ? a.scrollbarSize : 0) : Math.round(a.scrollbarSize / 2))),
                                      (h = r[d]() + h / o.kx)),
                                (n.scrollTo = n.scrollTo || {}),
                    ...
                    e.each(u, function (e, t) {
                        ...
                        l.autoScrollSize && ((t.scrollbarSize = parseInt((c * u) / a, 10)), t.scroll.bar.css(o, t.scrollbarSize + "px")),
            ...
            _updateScroll: function (t, n) {
                var i = this.container,
                    ...
                    d = n.visible + l;
                (n.isVisible = c - d > 1),
                    n.isVisible ? (n.scroll.addClass(s), a.scroll.addClass(s), r.addClass(s)) : (n.scroll.removeClass(s), a.scroll.removeClass(s), r.removeClass(s)),
                    "y" === t &&
                        (i.is("textarea") || d > c
                            ? r.css({
                    ...
                    (l = o.scrolls[i]),
                        ...
                        (n ||
                            (a.autoUpdate &&
                                c &&
                                c.is(":visible") &&
                                (s.prop("scrollWidth") != d.size || s.prop("scrollHeight") != p.size || c.width() != d.visible || c.height() != p.visible))) &&
                            (l.init(),
                            a.debug &&
                                (window.console &&
                                    console.log(
            ...
            if ("function" != typeof jQuery.easing[t]) {
                var n = function (e, t) {
                    var n = [null, null],
                        ...
                        a = function (e) {
                            for (var t, n = e, i = 0; ++i < 14 && ((t = o(n, 0) - e), !(Math.abs(t) < 0.001)); ) n -= t / s(n);
                            return n;
                        };
                    return function (e) {
                        return o(a(e), 1);
                    ...
                    if (s.clone === !0)
                        ...
                        (i = function () {
                            (l = a.parents().addBack().filter(":hidden")),
                                (c += "visibility: hidden !important; display: " + s.display + " !important; "),
                ...
                for (var o in e) {
                    ...
                    for (var a in this.waypoints[o]) {
                        ...
                        f.element !== f.element.window && (m = f.adapter.offset()[s.offsetProp]),
                            "function" == typeof h
                                ? (h = h.apply(f))
                                : "string" == typeof h && ((h = parseFloat(h)), f.options.offset.indexOf("%") > -1 && (h = Math.ceil((s.contextDimension * h) / 100))),
                            ...
                            !v && d
                                ...
                                : v && s.oldScroll >= f.triggerPoint && (f.queueTrigger(s.forward), (i[f.group.id] = f.group));
                    }
                }
                return (
    ...
    (function (e) {
        ...
        return (function (e, t, n, i) {
                    ...
                    g.isString(e)
                        ...
                        : (n =
                              g.isArray(e) && 1 === e.length
                                  ...
                                  ? l.apply(null, e)
                                  : !1),
                    n === !1 && (n = w.Easings[w.defaults.easing] ? w.defaults.easing : y),
                    n
                );
            }
                                            ...
                                            if (((D.currentValue = O), "tween" === E)) m = O;
                                                ...
                                                x.Hooks.registered[E] &&
                                                    (x.Normalizations.registered[M]
                                                        ? (s(C).rootPropertyValueCache[M] = x.Normalizations.registered[M]("extract", null, F[1]))
                                                        : (s(C).rootPropertyValueCache[M] = F[1])),
                                                    "transform" === F[0] && (T = !0);
                                            }
                                        }
                                    u.mobileHA && s(C).transformCache.translate3d === i && ((s(C).transformCache.translate3d = "(0px, 0px, 0px)"), (T = !0)),
                                        T && x.flushTransformCache(C);
                                }
                            }
                            u.display !== i && "none" !== u.display && (w.State.calls[o][2].display = !1),
                                u.visibility !== i && "hidden" !== u.visibility && (w.State.calls[o][2].visibility = !1),
                                u.progress && u.progress.call(a[1], a[1], v, Math.max(0, f + u.duration - t), f, m),
                                1 === v && d(o);
                        }
                }
            ...
            function d(e, t) {
                ...
                for (var n = w.State.calls[e][0], r = w.State.calls[e][1], o = w.State.calls[e][2], a = w.State.calls[e][4], l = !1, u = 0, c = n.length; c > u; u++) {
                    ...
                    if (
                        (t ||
                            o.loop ||
                            ("none" === o.display && x.setPropertyValue(d, "display", o.display), "hidden" === o.visibility && x.setPropertyValue(d, "visibility", o.visibility)),
                        o.loop !== !0 && (p.queue(d)[1] === i || !/\.velocityQueueEntryFlag/i.test(p.queue(d)[1])) && s(d))
                    ) {
            ...
            var p,
                ...
                m = !1;
            if ((e.fn && e.fn.jquery ? ((p = e), (m = !0)) : (p = t.Velocity.Utilities), 8 >= f && !m))
            ...
            t.pageYOffset !== i
                ? ((w.State.scrollAnchor = t), (w.State.scrollPropertyLeft = "pageXOffset"), (w.State.scrollPropertyTop = "pageYOffset"))
                : ((w.State.scrollAnchor = n.documentElement || n.body.parentNode || n.body),
            ...
            var x = (w.CSS = {
                                ...
                                case "extract":
                                    ...
                                    return (
                                        x.RegEx.wrappedValueAlreadyExtracted.test(n)
                                            ? (i = n)
                                            : ((i = n.toString().match(x.RegEx.valueUnwrap)), (i = i ? i[1].replace(/,(\s+)?/g, " ") : n)),
                                        i
                                    );
                                case "inject":
                                    return "rect(" + n + ")";
                            ...
                            !(function () {
                                ...
                                x.Normalizations.registered[t] = function (e, n, r) {
                                    switch (e) {
                                        ...
                                        case "inject":
                                            return (
                                                8 >= f ? 4 === r.split(" ").length && (r = r.split(/\s+/).slice(0, 3).join(" ")) : 3 === r.split(" ").length && (r += " 1"),
                ...
                getPropertyValue: function (e, n, r, o) {
                    function a(e, n) {
                        ...
                        if (8 >= f) l = p.css(e, n);
                            ...
                            var u = !1;
                            if (
                                (/^(width|height)$/.test(n) && 0 === x.getPropertyValue(e, "display") && ((u = !0), x.setPropertyValue(e, "display", x.Values.getDisplayType(e))),
                                !o)
                            ) {
                    ...
                    if (x.Hooks.registered[n]) {
                        ...
                        (d = x.Normalizations.registered[n]("name", e)),
                            "transform" !== d && ((h = a(e, x.Names.prefixCheck(d)[0])), x.Values.isCSSNullValue(h) && x.Hooks.templates[n] && (h = x.Hooks.templates[n][1])),
                ...
                setPropertyValue: function (e, n, i, r, o) {
                    ...
                    if ("scroll" === n)
                        ...
                        x.Normalizations.registered[n]("inject", e, i), (a = "transform"), (i = s(e).transformCache[n]);
                    else {
                        if (x.Hooks.registered[n]) {
                            var l = n,
                                u = x.Hooks.getRoot(n);
                        ...
                        if (
                            (x.Normalizations.registered[n] && ((i = x.Normalizations.registered[n]("inject", e, i)), (n = x.Normalizations.registered[n]("name", e))),
                ...
                flushTransformCache: function (e) {
                    ...
                    if ((f || (w.State.isAndroid && !w.State.isChrome)) && s(e).isSVG) {
                        ...
                        p.each(s(e).transformCache, function (t) {
                            return (
                                (r = s(e).transformCache[t]), "transformPerspective" === t ? ((o = r), !0) : (9 === f && "rotateZ" === t && (t = "rotate"), void (n += t + r + " "))
                            );
                        }),
                            o && (n = "perspective" + o + " " + n);
                    }
            ...
            var S = function () {
                ...
                function r() {
                    function e(e) {
                                    ...
                                    ? ((n = e[0]),
                                      (!g.isArray(e[1]) && /^[\d-]/.test(e[1])) || g.isFunction(e[1]) || x.RegEx.isHex.test(e[1])
                                          ...
                                          : ((g.isString(e[1]) && !x.RegEx.isHex.test(e[1])) || g.isArray(e[1])) &&
                                            ((r = t ? e[1] : u(e[1], a.duration)), e[2] !== i && (s = e[2])))
                                    : (n = e),
                                t || (r = r || a.easing),
                        ...
                        function v() {
                            ...
                            if (r && i) (l.emToPx = F.lastEmToPx), (l.percentToPxWidth = F.lastPercentToPxWidth), (l.percentToPxHeight = F.lastPercentToPxHeight);
                                ...
                                w.init(u),
                                    ...
                                    (l.percentToPxWidth = F.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(u, "width", null, !0)) || 1) / a),
                                    (l.percentToPxHeight = F.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(u, "height", null, !0)) || 1) / a),
                                    (l.emToPx = F.lastEmToPx = (parseFloat(x.getPropertyValue(u, "paddingLeft")) || 1) / a),
                                    e.myParent.removeChild(u);
                            }
                            return (
                                null === F.remToPx && (F.remToPx = parseFloat(x.getPropertyValue(n.body, "fontSize")) || 16),
                                null === F.vwToPx && ((F.vwToPx = parseFloat(t.innerWidth) / 100), (F.vhToPx = parseFloat(t.innerHeight) / 100)),
                                (l.remToPx = F.remToPx),
                                (l.vwToPx = F.vwToPx),
                                (l.vhToPx = F.vhToPx),
                                w.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), o),
                                l
                            );
                        }
                        ...
                        if ("scroll" === O) {
                            ...
                            a.container
                                ? g.isWrapped(a.container) || g.isNode(a.container)
                                    ? ((a.container = a.container[0] || a.container), (S = a.container["scroll" + D]), (_ = S + p(o).position()[D.toLowerCase()] + P))
                                    : (a.container = null)
                                : ((S = w.State.scrollAnchor[w.State["scrollProperty" + D]]),
                                  (T = w.State.scrollAnchor[w.State["scrollProperty" + ("Left" === D ? "Top" : "Left")]]),
                            ...
                            for (var M in A)
                                if ("element" !== M) {
                                    ...
                                    (A[M].startValue = A[M].currentValue = A[M].endValue),
                                        ...
                                        w.debug && console.log("reverse tweensContainer (" + M + "): " + JSON.stringify(A[M]), o);
                                }
                            l = A;
                        } else if ("start" === O) {
                            var A;
                            ...
                            for (var L in m) {
                                ...
                                if (s(o).isSVG || "tween" === H || x.Names.prefixCheck(H)[1] !== !1 || x.Normalizations.registered[H] !== i) {
                                    ((a.display !== i && null !== a.display && "none" !== a.display) || (a.visibility !== i && "hidden" !== a.visibility)) &&
                                        /opacity|filter/.test(L) &&
                                        !z &&
                                        0 !== Y &&
                                        (z = 0),
                                        a._cacheValues && A && A[L]
                                            ? (z === i && (z = A[L].endValue + A[L].unitType), (q = s(o).rootPropertyValueCache[H]))
                                            : x.Hooks.registered[L]
                                            ? z === i
                                                ? ((q = x.getPropertyValue(o, H)), (z = x.getPropertyValue(o, L, q)))
                                                : (q = x.Hooks.templates[H][1])
                                            : z === i && (z = x.getPropertyValue(o, L));
                                    var W,
                                        R,
                                        V,
                                        X = !1;
                                    if (
                                        ...
                                        "%" === R &&
                                            (/^(fontSize|lineHeight)$/.test(L)
                                                ...
                                                : /^scale/.test(L)
                                                ? ((Y /= 100), (R = ""))
                                                : /(Red|Green|Blue)$/i.test(L) && ((Y = (Y / 100) * 255), (R = ""))),
                                        /[\/*]/.test(X))
                                    )
                                        R = V;
                                    else if (V !== R && 0 !== z)
                        ...
                        l.element &&
                            ...
                            (s(o).isAnimating = !0),
                            C === k - 1 ? (w.State.calls.push([I, h, a, null, E.resolver]), w.State.isTicking === !1 && ((w.State.isTicking = !0), c())) : C++);
                    }
                    ...
                    switch (
                        ...
                        parseFloat(a.delay) &&
                            ...
                            p.queue(o, a.queue, function (e) {
                                (w.velocityQueueEntryFlag = !0), (s(o).delayTimer = { setTimeout: setTimeout(e, parseFloat(a.delay)), next: e });
                            }),
                    ...
                    w.mock !== !1 && (w.mock === !0 ? (a.duration = a.delay = 1) : ((a.duration *= parseFloat(w.mock) || 1), (a.delay *= parseFloat(w.mock) || 1))),
                        ...
                        a.display !== i &&
                            null !== a.display &&
                            ((a.display = a.display.toString().toLowerCase()), "auto" === a.display && (a.display = w.CSS.Values.getDisplayType(o))),
                        a.visibility !== i && null !== a.visibility && (a.visibility = a.visibility.toString().toLowerCase()),
                        (a.mobileHA = a.mobileHA && w.State.isMobile && !w.State.isGingerbread),
                        a.queue === !1
                            ? a.delay
                ...
                var a,
                    ...
                    m,
                    y,
                    b = arguments[0] && (arguments[0].p || (p.isPlainObject(arguments[0].properties) && !arguments[0].properties.names) || g.isString(arguments[0].properties));
                if (
                    (g.isWrapped(this) ? ((a = !1), (f = 0), (h = this), (l = this)) : ((a = !0), (f = 1), (h = b ? arguments[0].elements || arguments[0].e : arguments[0])),
                    (h = o(h)))
                ) {
                    ...
                    if (!/^(stop|finish|finishAll)$/i.test(m) && !p.isPlainObject(y)) {
                        ...
                        for (var _ = T; _ < arguments.length; _++)
                            g.isArray(arguments[_]) || (!/^(fast|normal|slow)$/i.test(arguments[_]) && !/^\d/.test(arguments[_]))
                        ...
                        case "stop":
                            p.each(h, function (e, t) {
                                s(t) && s(t).delayTimer && (clearTimeout(s(t).delayTimer.setTimeout), s(t).delayTimer.next && s(t).delayTimer.next(), delete s(t).delayTimer),
                                    "finishAll" !== m ||
                                        (y !== !0 && !g.isString(y)) ||
                                        (p.each(p.queue(t, g.isString(y) ? y : ""), function (e, t) {
                                            g.isFunction(t) && t();
                                        }),
                                ...
                                p.each(w.State.calls, function (e, t) {
                                    t &&
                                        p.each(t[1], function (n, r) {
                                            var o = y === i ? "" : y;
                                            return o === !0 || t[2].queue === o || (y === i && t[2].queue === !1)
                                                ? void p.each(h, function (n, i) {
                                                      i === r &&
                                                          ((y === !0 || g.isString(y)) &&
                                                              (p.each(p.queue(i, g.isString(y) ? y : ""), function (e, t) {
                            ...
                            if (!p.isPlainObject(m) || g.isEmptyObject(m)) {
                                if (g.isString(m) && w.Redirects[m]) {
                                    ...
                                    return (
                                        ...
                                        p.each(h, function (e, t) {
                                            parseFloat(P.stagger) ? (P.delay = M + parseFloat(P.stagger) * e) : g.isFunction(P.stagger) && (P.delay = M + P.stagger.call(t, e, k)),
                                                P.drag &&
                                                    ((P.duration = parseFloat(A) || (/^(callout|transition)/.test(m) ? 1e3 : v)),
                                                    (P.duration = Math.max(P.duration * (P.backwards ? 1 - e / k : (e + 1) / k), 0.75 * P.duration, 200))),
                                                w.Redirects[m].call(t, t, P || {}, e, k, h, E.promise ? E : i);
                                        }),
                                        e()
                                    );
                                }
                ...
                p.each(["Down", "Up"], function (e, t) {
                    w.Redirects["slide" + t] = function (e, n, r, o, s, a) {
                        var l = p.extend({}, n),
                            ...
                            f = {};
                        l.display === i && (l.display = "Down" === t ? ("inline" === w.CSS.Values.getDisplayType(e) ? "inline-block" : "block") : "none"),
                            (l.begin = function () {
                                u && u.call(s, s);
                                for (var n in d) {
                                    f[n] = e.style[n];
                ...
                t
                    ...
                    .each(function () {
                        ...
                        if (f.is(d)) t.append(f);
                            ...
                            if (u) return !0;
                            t.append(f),
                                !l || f.is(a.after) || f.find(a.after).length || t[t.is(c) ? "after" : "append"](l),
                                o(s, a) && ((u = 3 == p.nodeType ? r(f, n, s, a, l) : i(f, n, s, a, l)), u || (f.detach(), (u = !0))),
                                u || (l && l.detach());
                        }
                    }),
        ...
        function r(t, n, i, r, a) {
            ...
            for (r.fallbackToLetter && 0 == y && 0 == w && ((h = ""), (g = p.split(h)), (w = g.length - 1)); w >= y && (0 != y || 0 != w); ) {
                ...
                (v = b),
                    ...
                    o(i, r)
                        ? ((w = v), r.fallbackToLetter && 0 == y && 0 == w && ((h = ""), (g = g[0].split(h)), (m = -1), (v = -1), (y = 0), (w = g.length - 1)))
                        : ((m = v), (y = v));
            }
            if (-1 == m || (1 == g.length && 0 == g[0].length)) {
                ...
                x.contents().length > S ? (c = d(x.contents().eq(-1 - S), n)) : ((c = d(x, n, !0)), S || x.detach()),
                            ...
                            r
                                .bind("update.dot", function (t, a) {
                                    ...
                                    (l.maxHeight += l.tolerance),
                                        "undefined" != typeof a &&
                                            (("string" == typeof a || ("nodeType" in a && 1 === a.nodeType)) && (a = e("<div />").append(a).contents()), a instanceof e && (s = a)),
                                    ...
                                    var c = !1,
                                        d = !1;
                                    return (
                                        u.afterElement && ((c = u.afterElement.clone(!0)), c.show(), u.afterElement.detach()),
                                        o(g, l) && (d = "children" == l.wrap ? n(g, l, c) : i(g, r, g, l, c)),
    ...
    (function (e) {
        ...
        (_determinate = "determinate"),
            ...
            (e.fn[l] = function (o, s) {
                ...
                var m = e.extend({ checkedClass: p, disabledClass: h, indeterminateClass: _indeterminate, labelHover: !0 }, o),
                    v = m.handle,
                ...
                return (
                    ...
                    f.each(function () {
                        ...
                        var s,
                            ...
                            T = _mobile ? { position: "absolute", visibility: "hidden" } : k ? C : { position: "absolute", opacity: 0 },
                        ...
                        O &&
                            ...
                            t(o, !0, _update),
                            E.length &&
                                E.on(_click + ".i mouseover.i mouseout.i " + _touch, function (n) {
                                    var i = n[_type],
                                        r = e(this);
                                    if (!a[h]) {
                                        if (i == _click) {
                            ...
                            o.on(_click + ".i focus.i blur.i keyup.i keydown.i keypress.i", function (e) {
                                ...
                                return t == _click
                                    ? !1
                                    : "keydown" == t && 32 == r
                                    ? ((a[_type] == d && a[p]) || (a[p] ? i(o, p) : n(o, p)), !1)
                                    : void ("keyup" == t && a[_type] == d ? !a[p] && n(o, p) : /us|ur/.test(t) && P["blur" == t ? _remove : _add](w));
                            }),
                            s.on(_click + " mousedown mouseup mouseover mouseout " + _touch, function (e) {
                                ...
                                if (!a[h]) {
                                    if (
                                        (n == _click
                                            ? t(o, !1, !0)
                                            : (/wn|er|in/.test(n) ? P[_add](i) : P[_remove](i + " " + b), E.length && x && i == y && E[/ut|nd/.test(n) ? _remove : _add](S)),
                                        !_mobile)
                                    )
                                        return !1;
                                    e.stopPropagation();
        ...
        var t = function (e, t) {
                return "number" == typeof e && "number" == typeof t
                    ? e > t
                        ...
                        ? -1
                        : 0
                    : ((e = a(String(e || ""))), (t = a(String(t || ""))), e > t ? 1 : t > e ? -1 : 0);
            },
            n = function (e, t) {
                var n, i, r, o;
    ...
    (function (e, t) {
        ...
        (r.prototype = {
            ...
            off: function (e, t) {
                ...
                return 0 === n
                    ...
                    : ((this._events = this._events || {}), void (e in this._events != !1 && this._events[e].splice(this._events[e].indexOf(t), 1)));
            },
            trigger: function (e) {
        ...
        var D = function (e) {
                            ...
                            n.metaKey ||
                                ...
                                ((i.force || e.data("grow") !== !1) &&
                                    ...
                                    n.type &&
                                        ...
                                        ((o = n.keyCode),
                                        (s = (o >= 97 && 122 >= o) || (o >= 65 && 90 >= o) || (o >= 48 && 57 >= o) || 32 === o),
                                        o === m || o === g
                                            ? ((d = N(e[0])),
                                              d.length
                                                  ? (r = r.substring(0, d.start) + r.substring(d.start + d.length))
                                                  : o === g && d.start
                                                  ? (r = r.substring(0, d.start - 1) + r.substring(d.start + 1))
                                                  : o === m && "undefined" != typeof d.start && (r = r.substring(0, d.start) + r.substring(d.start + 1)))
                                            : s && ((u = n.shiftKey), (c = String.fromCharCode(n.keyCode)), (c = u ? c.toUpperCase() : c.toLowerCase()), (r += c))),
                                    (a = e.attr("placeholder")),
                                    !r && a && (r = a),
                                    (l = I(r, e) + 4),
                                    l !== t && ((t = l), e.width(l), e.triggerHandler("resize"))));
                    };
            ...
            j = function (n, i) {
                ...
                if (
                    ((s = u ? u.getPropertyValue("direction") : a.currentStyle && a.currentStyle.direction),
            ...
            e.extend(j.prototype, {
                setup: function () {
                    ...
                    if (
                        ...
                        (n = e("<div>").addClass(p.inputClass).addClass("items").appendTo(t)),
                        (i = e('<input type="text" autocomplete="off" />')
                            .appendTo(n)
                            .attr("tabindex", m.is(":disabled") ? "-1" : d.tabIndex)),
                        (a = e(p.dropdownParent || t)),
                        (r = e("<div>").addClass(p.dropdownClass).addClass(l).hide().appendTo(a)),
                        ...
                        d.plugins.names.length && ((c = "plugin-" + d.plugins.names.join(" plugin-")), t.addClass(c), r.addClass(c)),
                ...
                onKeyDown: function (e) {
                    ...
                    switch (e.keyCode) {
                        ...
                        case b:
                            return (
                                t.settings.selectOnTab && t.isOpen && t.$activeOption && (t.onOptionSelect({ currentTarget: t.$activeOption }), t.isFull() || e.preventDefault()),
                        ...
                        if (((i = n && n.type.toLowerCase()), "mousedown" === i && d.isShiftDown && d.$activeItems.length)) {
                            for (
                                c = d.$control.children(".active:last"),
                                    s = Array.prototype.indexOf.apply(d.$control[0].childNodes, [c[0]]),
                                    a = Array.prototype.indexOf.apply(d.$control[0].childNodes, [t[0]]),
                                    s > a && ((u = s), (s = a), (a = u)),
                                    r = s;
                                a >= r;
                                r++
                            )
                                (l = d.$control[0].childNodes[r]), -1 === d.$activeItems.indexOf(l) && (e(l).addClass("active"), d.$activeItems.push(l));
                            n.preventDefault();
                        } else
                            ("mousedown" === i && d.isCtrlDown) || ("keydown" === i && this.isShiftDown)
                                ? t.hasClass("active")
                                    ? ((o = d.$activeItems.indexOf(t[0])), d.$activeItems.splice(o, 1), t.removeClass("active"))
                                    : d.$activeItems.push(t.addClass("active")[0])
                                : (e(d.$activeItems).removeClass("active"), (d.$activeItems = [t.addClass("active")[0]]));
                    ...
                    u.$activeOption && u.$activeOption.removeClass("active"),
                        ...
                        t.length &&
                            ...
                            (n || !C(n)) &&
                                ...
                                (l = s - r + o),
                                s + o > r + n
                                    ? u.$dropdown_content.stop().animate({ scrollTop: l }, i ? u.settings.scrollDuration : 0)
                                    : n > s && u.$dropdown_content.stop().animate({ scrollTop: a }, i ? u.settings.scrollDuration : 0)));
                },
                selectAll: function () {
                    var e = this;
                ...
                search: function (t) {
                    ...
                    if (s.score && ((r = o.settings.score.apply(this, [t])), "function" != typeof r))
                        throw new Error('Selectize "score" setting must be a function that returns a function');
                    if (
                        (t !== o.lastQuery
                            ? ((o.lastQuery = t), (i = o.sifter.search(t, e.extend(a, { score: r }))), (o.currentResults = i))
                ...
                refreshOptions: function (t) {
                    ...
                    for (s = x.items.length, "number" == typeof w.settings.maxOptions && (s = Math.min(s, w.settings.maxOptions)), a = {}, l = [], n = 0; s > n; n++)
                        for (
                            u = w.options[x.items[n].id], c = w.render("option", u), d = u[w.settings.optgroupField] || "", p = e.isArray(d) ? d : [d], r = 0, o = p && p.length;
                            o > r;
                            r++
                        )
                            (d = p[r]), w.optgroups.hasOwnProperty(d) || (d = ""), a.hasOwnProperty(d) || ((a[d] = []), l.push(d)), a[d].push(c);
                    for (
                        ...
                        (d = l[n]),
                            w.optgroups.hasOwnProperty(d) && a[d].length
                                ? ((h = w.render("optgroup_header", w.optgroups[d]) || ""),
                                  (h += a[d].join("")),
                                  f.push(w.render("optgroup", e.extend({}, w.optgroups[d], { html: h }))))
                                : f.push(a[d].join(""));
                    ...
                    (g = w.canCreate(b)),
                        g && (S.prepend(w.render("option_create", { input: b })), (y = e(S[0].childNodes[0]))),
                        (w.hasOptions = x.items.length > 0 || g),
                        w.hasOptions
                            ? (x.items.length > 0
                                  ? ((v = k && w.getOption(k)),
                                    v && v.length ? (m = v) : "single" === w.settings.mode && w.items.length && (m = w.getOption(w.items[0])),
                                    (m && m.length) || (m = y && !w.settings.addPrecedence ? w.getAdjacentOption(y, 1) : S.find("[data-selectable]:first")))
                                  : (m = y),
                              w.setActiveOption(m),
                              t && !w.isOpen && w.open())
                ...
                updateOption: function (t, n) {
                    ...
                    if (((t = T(t)), (o = T(n[c.settings.valueField])), null !== t && c.options.hasOwnProperty(t))) {
                        ...
                        (u = c.options[t].$order),
                            o !== t && (delete c.options[t], (s = c.items.indexOf(t)), -1 !== s && c.items.splice(s, 1, o)),
                            (n.$order = n.$order || u),
                            (c.options[o] = n),
                            ...
                            -1 !== c.items.indexOf(o) && ((i = c.getItem(t)), (r = e(c.render("item", n))), i.hasClass("active") && r.addClass("active"), i.replaceWith(r)),
                            (c.lastQuery = null),
                                ...
                                : void (
                                      ...
                                      ("multi" === u && l.isFull()) ||
                                          ...
                                          l.isSetup &&
                                              ...
                                              !o.length || l.isFull() ? l.close() : l.positionDropdown(),
                                              l.updatePlaceholder(),
                    ...
                    var s =
                        ...
                        a = D(function (e) {
                            ...
                            return "string" != typeof t
                                ? o()
                                : (i.setTextboxValue(""), i.addOption(e), i.setCaret(r), i.addItem(t), i.refreshOptions(n && "single" !== i.settings.mode), void o(e));
                        }),
                        l = s.apply(this, [t, a]);
                ...
                updateOriginalInput: function (e) {
                    ...
                    if (((e = e || {}), o.tagType === x)) {
                        for (i = [], t = 0, n = o.items.length; n > t; t++)
                            (r = o.options[o.items[t]][o.settings.labelField] || ""), i.push('<option value="' + _(o.items[t]) + '" selected="selected">' + _(r) + "</option>");
                ...
                deleteSelection: function (t) {
                    ...
                    if (
                        ...
                        d.$activeOption && !d.settings.hideSelected && (l = d.getAdjacentOption(d.$activeOption, -1).attr("data-value")),
                        (s = []),
                        ...
                        (d.isFocused || "single" === d.settings.mode) &&
                            ...
                            (0 > r && 0 === o.start && 0 === o.length
                                ...
                                : r > 0 && o.start === d.$control_input.val().length && s.push(d.items[d.caretPos]));
                ...
                advanceSelection: function (e, t) {
                    ...
                    0 !== e &&
                        ...
                        l.isFocused && !l.isInputHidden
                            ? ((o = l.$control_input.val().length), (s = 0 > e ? 0 === i.start && 0 === i.length : i.start === o), s && !o && l.advanceCaret(e, t))
                            : ((a = l.$control.children(".active:" + n)),
                              a.length && ((r = l.$control.children(":not(input)").index(a)), l.setActiveItem(null), l.setCaret(e > 0 ? r + 1 : r))));
                },
                advanceCaret: function (e, t) {
                    ...
                    0 !== e &&
                        ((n = e > 0 ? "next" : "prev"),
                        r.isShiftDown ? ((i = r.$control_input[n]()), i.length && (r.hideInput(), r.setActiveItem(i), t && t.preventDefault())) : r.setCaret(r.caretPos + e));
                },
                setCaret: function (t) {
                    var n = this;
                    if (((t = "single" === n.settings.mode ? n.items.length : Math.max(0, Math.min(n.items.length, t))), !n.isPending)) {
                        var i, r, o, s;
                        for (o = n.$control.children(":not(input)"), i = 0, r = o.length; r > i; i++)
                            (s = e(o[i]).detach()), t > i ? n.$control_input.before(s) : n.$control.append(s);
                    }
                    n.caretPos = t;
                },
                lock: function () {
                ...
                destroy: function () {
                    ...
                    t.trigger("destroy"),
                        ...
                        t.$wrapper.remove(),
                        t.$dropdown.remove(),
                        t.$input.html("").append(i.$children).removeAttr("tabindex").removeClass("selectized").attr({ tabindex: i.tabindex }).show(),
                ...
                render: function (e, t) {
                    ...
                    return (
                        ("option" === e || "item" === e) && ((n = T(t[s.settings.valueField])), (o = !!n)),
                        o && (C(s.renderCache[e]) || (s.renderCache[e] = {}), s.renderCache[e].hasOwnProperty(n))
                            ? s.renderCache[e][n]
                            : ((r = s.settings.render[e].apply(this, [t, _])),
                              ("option" === e || "option_create" === e) && (r = r.replace(a, "<$1 data-selectable")),
                              "optgroup" === e && ((i = t[s.settings.optgroupValueField] || ""), (r = r.replace(a, '<$1 data-group="' + E(_(i)) + '"'))),
                              ("option" === e || "item" === e) && (r = r.replace(a, '<$1 data-value="' + E(_(n || "")) + '"')),
                    ...
                    d = function (t, n) {
                        var c,
                            ...
                            y = function (t) {
                                var i, r, o, s, a;
                                for (
                                    t = e(t), o = t.attr("label"), o && ((s = m(t) || {}), (s[l] = o), (s[u] = o), n.optgroups.push(s)), a = e("option", t), i = 0, r = a.length;
                                    r > i;
                                    i++
                                )
                                    v(a[i], o);
                            };
                        for (n.maxItems = t.attr("multiple") ? null : 1, f = t.children(), c = 0, d = f.length; d > c; c++)
                            (p = f[c].tagName.toLowerCase()), "optgroup" === p ? y(f[c]) : "option" === p && v(f[c]);
                    };
                return this.each(function () {
                    if (!this.selectize) {
                        var r,
                        ...
                        return function (t) {
                            ...
                            return !this.isOpen || (t.keyCode !== u && t.keyCode !== p)
                                ...
                                : ((n.ignoreHover = !0),
                                  ...
                                  (s = t.keyCode === u ? s.prev("[data-group]") : s.next("[data-group]")),
            ...
            j.define("restore_on_backspace", function (e) {
                ...
                (e.text =
                    ...
                    (this.onKeyDown = (function () {
                        ...
                        return function (t) {
                            var i, r;
                            return t.keyCode === g && "" === this.$control_input.val() && !this.$activeItems.length && ((i = this.caretPos - 1), i >= 0 && i < this.items.length)
                                ? ((r = this.options[this.items[i]]),
                                  this.deleteSelection(t) && (this.setTextboxValue(e.text.apply(this, [r])), this.refreshOptions(!0)),
    ...
    (function () {
        function e(t) {
            ...
            return (
                "exports" in n || "function" != typeof n.definition || ((n.client = n.component = !0), n.definition.call(this, (n.exports = {}), n), delete n.definition), n.exports
            );
        }
                    ...
                    (n.prototype.onTouchEnd = function (e) {
                        ...
                        if (
                            ...
                            return e.timeStamp - n > 100 || (this.deviceIsIOS && window.top !== window && "input" === i)
                                ? ((this.targetElement = null), !1)
                                : (this.focus(s), (this.deviceIsIOS4 && "select" === i) || ((this.targetElement = null), e.preventDefault()), !1);
                        return this.deviceIsIOS && !this.deviceIsIOS4 && ((r = s.fastClickScrollParent), r && r.fastClickLastScrollTop !== r.scrollTop)
                            ? !0
            ...
            e.register("component~classes@1.2.1", function (t, n) {
                ...
                (n.exports = function (e) {
                    ...
                    (i.prototype.toggle = function (e, t) {
                        return this.list
                            ? ("undefined" != typeof t ? t !== this.list.toggle(e, t) && this.list.toggle(e) : this.list.toggle(e), this)
                            : ("undefined" != typeof t ? (t ? this.add(e) : this.remove(e)) : this.has(e) ? this.remove(e) : this.add(e), this);
                    }),
                        ...
                        e && t ? (t = !1) : e && !t && (t = !0),
                            t === !0
                                ...
                                : ((i.style.left = 0),
                                  ...
                                  (this.switcher.style.backgroundColor = this.options.secondaryColor !== l.secondaryColor ? this.options.secondaryColor : "#fff"),
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
    Prism = (function () {
        var e = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
            t = (_self.Prism = {
                ...
                highlightAll: function (e, n) {
                    for (
                        var i, r = document.querySelectorAll('code[class*="language-"], [class*="language-"] code, code[class*="lang-"], [class*="lang-"] code'), o = 0;
                        (i = r[o++]);

                    )
                        t.highlightElement(i, e === !0, n);
                },
                highlightElement: function (n, i, r) {
                    for (var o, s, a = n; a && !e.test(a.className); ) a = a.parentNode;
                    a && ((o = (a.className.match(e) || [, ""])[1]), (s = t.languages[o])),
                    ...
                    var l = n.textContent,
                        u = { element: n, language: o, grammar: s, code: l };
        ...
        return (
            (i = i[i.length - 1]),
            i && ((t.filename = i.src), document.addEventListener && !i.hasAttribute("data-manual") && document.addEventListener("DOMContentLoaded", t.highlightAll)),
            _self.Prism
        );
    })();
"undefined" != typeof module && module.exports && (module.exports = Prism),
        ...
        Prism.hooks.add("after-highlight", function (e) {
            if ("php" === e.language) {
                for (var t, n = 0; (t = e.tokenStack[n]); n++)
                    e.highlightedCode = e.highlightedCode.replace("{{{PHP" + (n + 1) + "}}}", Prism.highlight(t, e.grammar, "php").replace(/\$/g, "$$$$"));
        ...
        function n(e) {
            function t() {
                ...
                (p = t.overflowY),
                    ...
                    (d =
                        "content-box" === t.boxSizing ? -(parseFloat(t.paddingTop) + parseFloat(t.paddingBottom)) : parseFloat(t.borderTopWidth) + parseFloat(t.borderBottomWidth)),
                    isNaN(d) && (d = 0),
                    r();
            }
            ...
            function i() {
                ...
                return 0 === e.scrollHeight
                    ...
                    : ((e.style.height = r + "px"), (f = e.clientWidth), (document.documentElement.scrollTop = t), void (document.body.scrollTop = n));
            }
            ...
            if (e && e.nodeName && "TEXTAREA" === e.nodeName && !o.has(e)) {
                var d = null,
                    ...
                    g = function (t) {
                        window.removeEventListener("resize", h, !1),
                            ...
                            e.removeEventListener("autosize:destroy", g, !1),
                ...
                e.addEventListener("autosize:destroy", g, !1),
    ...
    (function (e, t, n, i) {
        ...
        function P(e) {
            for (var t = [], n = 0; n < e.pointers.length; )
                (t[n] = {
                    ...
                    n++;
            return { timeStamp: fe(), pointers: t, center: A(t), deltaX: e.deltaX, deltaY: e.deltaY };
        }
        ...
        var Ye = { mousedown: Ce, mousemove: Te, mouseup: _e },
            $e = "mousedown",
        ...
        var He = { pointerdown: Ce, pointermove: Te, pointerup: _e, pointercancel: Ee, pointerout: Ee },
            qe = { 2: we, 3: be, 4: xe, 5: Se },
            We = "pointerdown",
            Re = "pointermove pointerup pointercancel";
        e.MSPointerEvent && ((We = "MSPointerDown"), (Re = "MSPointerMove MSPointerUp MSPointerCancel")),
            u($, C, {
                handler: function (e) {
                    var t = this.store,
                        n = !1,
                    ...
                    r & Ce && (0 === e.button || s) ? 0 > a && (t.push(e), (a = t.length - 1)) : r & (_e | Ee) && (n = !0),
                        0 > a ||
                            ((t[a] = e),
        ...
        var Ve = { touchstart: Ce, touchmove: Te, touchend: _e, touchcancel: Ee },
            Xe = "touchstart",
        ...
        u(z, C, {
            handler: function (e) {
                ...
                if ((t === Ce && (this.started = !0), this.started)) {
                    ...
                    t & (_e | Ee) && n[0].length - n[1].length === 0 && (this.started = !1),
                        this.callback(this.manager, t, {
                            pointers: n[0],
                            changedPointers: n[1],
                            pointerType: we,
        ...
        var Ue = { touchstart: Ce, touchmove: Te, touchend: _e, touchcancel: Ee },
            Ge = "touchstart touchmove touchend touchcancel";
        u(q, C, {
            handler: function (e) {
                var t = Ue[e.type],
                    n = W.call(this, e, t);
                n && this.callback(this.manager, t, { pointers: n[0], changedPointers: n[1], pointerType: we, srcEvent: e });
            },
        }),
            u(R, C, {
        ...
        (B.prototype = {
            ...
            recognize: function (e) {
                ...
                return d(this.options.enable, [this, t])
                    ? (this.state & (lt | ut | ct) && (this.state = rt), (this.state = this.process(t)), void (this.state & (ot | st | at | ut) && this.tryEmit(t)))
                    : (this.reset(), void (this.state = ct));
            },
            process: function (e) {},
            ...
            u(K, Q, {
                defaults: { event: "pan", threshold: 10, pointers: 1, direction: Ie },
                getTouchAction: function () {
                ...
                directionTest: function (e) {
                    ...
                    return (
                        r & t.direction ||
                            (t.direction & Ne
                                ? ((r = 0 === o ? Oe : 0 > o ? De : Pe), (n = o != this.pX), (i = Math.abs(e.deltaX)))
                                : ((r = 0 === s ? Oe : 0 > s ? Ae : Me), (n = s != this.pY), (i = Math.abs(e.deltaY)))),
                        (e.direction = r),
                ...
                emit: function (e) {
                    this.state === lt &&
                        (e && e.eventType & _e
                            ...
                            : ((this._input.timeStamp = fe()), this.manager.emit(this.options.event, this._input)));
                },
            }),
            u(te, Q, {
            ...
            u(ne, Q, {
                defaults: { event: "swipe", threshold: 10, velocity: 0.65, direction: Ne | Fe, pointers: 1 },
                getTouchAction: function () {
                ...
                attrTest: function (e) {
                    ...
                    return (
                        n & (Ne | Fe) ? (t = e.velocity) : n & Ne ? (t = e.velocityX) : n & Fe && (t = e.velocityY),
                        this._super.attrTest.call(this, e) && n & e.direction && e.distance > this.options.threshold && pe(t) > this.options.velocity && e.eventType & _e
                    );
                },
                emit: function (e) {
                    var t = G(e.direction);
            ...
            recognize: function (e) {
                ...
                if (!t.stopped) {
                    ...
                    for (var o = 0; o < i.length; )
                        (n = i[o]),
                            t.stopped === pt || (r && n != r && !n.canRecognizeWith(r)) ? n.reset() : n.recognize(e),
                            !r && n.state & (ot | st | at) && (r = t.curRecognizer = n),
                            o++;
                }
            },
            get: function (e) {
