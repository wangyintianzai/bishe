            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select
                            class="form-control class_chufangyuan48"
                        ...
                        <script>
                            $(".class_chufangyuan48").val($(".class_chufangyuan48").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        危机等级
                        ...
                        <select
                            class="form-control class_weijidengji49"
                        ...
                        <script>
                            $(".class_weijidengji49").val($(".class_weijidengji49").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        问题类型
                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${list}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td>${map.zongdefen}</td>
                                <td>
                                    <ssm:sql var="mapyuangong6" type="find">SELECT xingming,id FROM yuangong where gonghao='${map.chufangyuan}'</ssm:sql>${mapyuangong6.xingming}
                                </td>
