...
<nav id="header-box">
    <div class="container">
        ...
        <a href="{url home}" class="logo"> 高校学生心理辅导系统 </a>
            ...
            <ul>
                ...
                <c:choose>
                    <c:when test="${sessionScope.username != null && sessionScope.username !=  '' }">
                        <li>
                            <a href="main.do"><i class="icon icon-user"></i>${sessionScope.username},${sessionScope.cx}</a>
                        </li>
                        <li>
                            <a href="logout.do"><i class="fa fa-sign-out"></i>退出</a>
                        </li> </c:when
                    ><c:otherwise>
                        <li>
        ...
        <div class="navigation navigation-main">
            ...
            <div class="floating-menu">
                ...
                <ul id="navbar-str">
                                ...
                                <div class="box-full">
                                    <div class="box clearfix">
                                        <ul>
                                            ...
                                            <c:forEach items="${mapxinwenfenlei1}" var="m">
                                                <li><a href="xinwenlist.do?fenlei=${m.id}">${m.fenleimingcheng}</a></li>
                                            </c:forEach>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <li>
                        <a href="yuangonglist.do">咨询师 </a>
                    </li>
                    <li>
                        <a href="chufangyuyueadd.do">预约初访 </a>
                    </li>
                    <li>
                        <a href="xueshengadd.do">用户注册 </a>
                    </li>
                    <li>
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <span class="input-group-addon"
                            ><img src="captcha.do" style="width: 60px; height: 20px; max-width: none; max-height: none" onclick="this.src='captcha.do?rand='+new Date().getTime()"
                        /></span>
                    </div>
                </div>
