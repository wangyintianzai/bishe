    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="yuangonginsert.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    remote="checkno.do?checktype=insert&table=yuangong&col=gonghao"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_zhiwei17"
                                    data-value="初访员"
                                    data-rule-required="true"
                                ...
                                <script>
                                    $(".class_zhiwei17").val($(".class_zhiwei17").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_xingbie18"
                                    data-value=""
                                    data-rule-required="true"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入擅长领域" style="width: 250px" id="shanchanglingyu" name="shanchanglingyu" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <textarea id="jieshao" name="jieshao" style="max-width: 750px; width: 100%; height: 300px"></textarea>
                                <script>
                                    (function () {
