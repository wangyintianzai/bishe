    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="yuangongupdate.do" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input
                                    ...
                                    remote="checkno.do?checktype=update&id=${mmm.id}&table=yuangong&col=gonghao"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_zhiwei19"
                                    data-value="${Info.html(mmm.zhiwei)}"
                                    data-rule-required="true"
                                ...
                                <script>
                                    $(".class_zhiwei19").val($(".class_zhiwei19").attr("data-value"));
                                </script>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select
                                    class="form-control class_xingbie20"
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">擅长领域</label>
                            <div class="col-sm-10">
                                <input
                                    type="text"
                                    class="form-control"
                                    ...
                                    style="width: 250px"
                                    id="shanchanglingyu"
                                    name="shanchanglingyu"
                                    value="${Info.html(mmm.shanchanglingyu)}"
                                />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">介绍</label>
                            <div class="col-sm-10">
                                <textarea id="jieshao" name="jieshao" style="max-width: 750px; width: 100%; height: 300px">${Info.html(mmm.jieshao)}</textarea>
                                <script>
                                    (function () {
